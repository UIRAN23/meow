...
// Генерация цвета аватара по нику
            ...
            child: StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snap) {
                if (snap.hasError) return Center(child: Padding(
                  ...
                  child: Text("Ошибка сети: ${snap.error}\n\nПроверьте интернет и настройки RLS в Supabase.", textAlign: TextAlign.center),
                ));
                    ...
                    return Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // ОТОБРАЖЕНИЕ ВРЕМЕНИ
                          Padding(
                            padding: const EdgeInsets.only(top: 2, left: 40, right: 10),
